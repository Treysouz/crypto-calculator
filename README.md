...
- The take-home assignment instructions strongly encourage Vite and Vue 3, so I went with Nuxt for SSG support to boost performance a bit. The boost is definitely negligible considering how small the application is, but I approached the assignment with scalability in mind. This is my first Vue project, but approaching it like I would a React application helped with any knowledge gaps.
